  ...
  return (
    <LegalPage title="Delete Account">
      ...
      <Section title="2. Deletion by email">
        If you cannot use the app, email <a href="mailto:info@vibecodingturkey.com">info@vibecodingturkey.com</a> from the email address linked to your account, or from any address with proof of account ownership (subscription receipt, etc.). State that you want to delete your account. We complete the deletion within 30 days and confirm by reply.
      </Section>
      ...
      <Section title="5. Recovery is not possible">
        Once deletion completes, your data is gone. We cannot recover worry entries, Mira chats, or memories after deletion. Export anything you want to keep first, by contacting <a href="mailto:info@vibecodingturkey.com">info@vibecodingturkey.com</a>.
      </Section>
    </LegalPage>
  );
}
